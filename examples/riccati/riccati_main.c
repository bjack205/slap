...
#define NINPUTS 2
#define NHORIZON 5
double Q_data[NSTATES * NSTATES] = {1, 0, 0, 0, 0.5, 0, 0, 0, 0.4};
double R_data[NINPUTS * NINPUTS] = {0.1, 0, 0, 0.2};
double q_data[NSTATES] = {-0.1, -0.2, -0.3};
double r_data[NINPUTS] = {0.1, 0.2};

double A_data[NSTATES * NSTATES] = {1, 0, 0, 0, 1, 0, 0, 0, 1};
double B_data[NSTATES * NINPUTS] = {.1, 0, 0, 0, .1, 0};
...
double y_data[NSTATES * NHORIZON];
